...
import TnewsListCard from './tnewsListCard'
import Loading from '../../../utils/loading'
import './tnewsListCard.css';

export default function Tnews(){
    const [posts, setPosts] = useState([])
    const [loading, setLoading] = useState(true)
    useEffect(()=>{
        Axios.get(`https://api-dev.trustnews.ca/allTnews?count=10000`).then(response =>{
