...
export default function AdminProcessingFeature(){
    ...
    function ApproveFeature(){
        Axios.get(`https://api-dev.trustnews.ca/approveFeature?postID=${data.state.postID}`).then(response =>{
            console.log(response)
        })
    }
    function DenyFeature(){
        Axios.get(`https://api-dev.trustnews.ca/denyFeature?postID=${data.state.postID}`).then(response =>{
            console.log(response)
        })
    }
    return(
        ...
        <div className='admin-processing-info'>
            ...
            {/* <p className='admin-processing-date'>20-20-2020</p> */}
        </div>
        {/* <p className='admin-processing-author'>author name</p> */}
        <div className='admin-processing-decise'>
            <div onClick={ApproveFeature} className='admin-processing-icon admin-approve'>
            ...
            <div onClick={DenyFeature} className='admin-processing-icon admin-dismiss'>
